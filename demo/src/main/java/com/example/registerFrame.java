...
public class registerFrame extends JFrame {
    ...
    public registerFrame() {
        ...
        showPwd1.addActionListener(handler);
        showPwd2.addActionListener(handler);

        showPwd1.setToolTipText("Show password");
        showPwd2.setToolTipText("Show password");
        // 各位置設定
    ...
    private class ButtonActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==showPwd1||e.getSource()==showPwd2){
                if(e.getSource()==showPwd1){
                ...
                else if(e.getSource()==showPwd2){
                    char echoChar = passWordText2.getEchoChar();
                    if (echoChar != 0) {
            ...
            else if(e.getSource()==confirm||e.getSource()==send){
