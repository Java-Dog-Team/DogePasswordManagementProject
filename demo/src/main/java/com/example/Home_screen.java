...
public class Home_screen{
    ...
    private static void putalarm(JFrame windowFrame){
        ...
        //縮小鬧鐘
        alarmPicture.setImage(alarmPicture.getImage().getScaledInstance((int)(0.15*w), (int)(0.15*h), Image.SCALE_DEFAULT));
    ...
    private static void putlock(JFrame windowFrame){
        ...
        //縮小鎖
        lockPicture.setImage(lockPicture.getImage().getScaledInstance((int)(0.15*w), (int)(0.15*h), Image.SCALE_DEFAULT));
